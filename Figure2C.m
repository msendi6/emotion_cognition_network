...
%   network connectivity (sFNC) and neuroticism (NT). It performs regression
%   analysis on sFNC edges, applies FDR correction, and outputs significant edges.
%
%   Note: This code just geenrate the result asscoited to Figure 2C
%   (Supplementary Data 3). The actual circulare figure will be generated in python
%   code
%
% Requirements:
%   - MATLAB R2022b 
...
output_dir='~/results';
cd(output_dir)
writetable(significant_results, 'Significant_NT_Edges.csv');% This is Supplementary Data 3
