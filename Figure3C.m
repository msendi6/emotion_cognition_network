% -----------------------------------------------------------------------------
% Script: Analyze NT-realted FNC with Clinical Outcomes in AURORA
% Description:
%This code output is  Supplementary Data 11,12, and 13
...
% Outputs:
%   - NT_Edges_stress.csv
%   - NT_Edges_anxiety.csv
%   - NT_Edges_depression.csv
%
% Author: Mo Sendi
% Date: 2024-12-10
% -----------------------------------------------------------------------------
...
filename = '~/results/Significant_NT_Edges.csv';
...
cd(output_dir)
writetable(results, 'NT_Edges_stress.csv');% This is Supplementary Data 11
...
output_dir='~/results/aurora';
cd(output_dir)
writetable(results, 'NT_Edges_anxiety.csv');% This is Supplementary Data 12
...
output_dir='~/results/aurora';
cd(output_dir)
writetable(results, 'NT_Edges_depression.csv');% This is Supplementary Data 13
