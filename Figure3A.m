...
%This code output is  Supplementary Data 5,6, and 7
% Description:
...
% Outputs:
%   - RT_Edges_stress.csv
%   - RT_Edges_anxiety.csv
%   - RT_Edges_depression.csv
%
% Author: Mo Sendi
% Date: 2024-12-10
% -----------------------------------------------------------------------------
...
filename = '~/results/Significant_RT_Edges.csv';
...
cd(output_dir)
writetable(results, 'RT_Edges_stress.csv'); % This is Supplementary Data 5
...
output_dir='~/results/aurora';
cd(output_dir)
writetable(results, 'RT_Edges_anxiety.csv');% This is Supplementary Data 6
...
output_dir='~/results/aurora';
cd(output_dir)
writetable(results, 'RT_Edges_depression.csv'); % This is Supplementary Data 7
