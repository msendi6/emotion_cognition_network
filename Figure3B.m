% -----------------------------------------------------------------------------
% Script: Analyze RT-realted FNC with Clinical Outcomes in AURORA
% Description:
%This code output is  Supplementary Data 8,9, and 10
...
% Outputs:
%   - WM_Edges_stress.csv
%   - WM_Edges_anxiety.csv
%   - WM_Edges_depression.csv
%
% Author: Mo Sendi
% Date: 2024-12-10
% -----------------------------------------------------------------------------
...
filename = '~/results/Significant_WM_Edges.csv';
...
cd(output_dir)
writetable(results, 'WM_Edges_stress.csv');% This is Supplementary Data 8
...
output_dir='~/results/aurora';
cd(output_dir)
writetable(results, 'WM_Edges_anxiety.csv'); % This is Supplementary Data 9
...
output_dir='~/results/aurora';
cd(output_dir)
writetable(results, 'WM_Edges_depression.csv');% This is Supplementary Data 10
