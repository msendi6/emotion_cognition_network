% -----------------------------------------------------------------------------
% Script: Analyze Aurora dFNC Variables (for the cognition network) with Clinical Outcomes
% Description:
...
% --- Load data
load('~/data/cog_cog_dfnc_variable.mat') % this file include demogrpahic, clinical, and dFNC measures (i.e., occupnacy rate for cognition network) for AURORA
